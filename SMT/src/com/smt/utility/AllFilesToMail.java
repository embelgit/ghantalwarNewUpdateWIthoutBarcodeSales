...
{		
	...
	public void sendTodaySaleReport()
	{
		...
		try
		{
			PrintWriter pw = new PrintWriter(new File("E:\\databackup\\TodaySaleReport.xlsx"));
	...
	public void sendTodayPurchaseReport()
	{
		...
		try
		{			
			PrintWriter pw = new PrintWriter(new File("E:\\databackup\\TodayPurchaseReport.xlsx"));
			StringBuilder sb = new StringBuilder();
	...
	public void sendTodaySaleReturnReport()
	{
		...
		try
		{
			...
			PrintWriter pw = new PrintWriter(new File("E:\\databackup\\TodaySaleReturnReport.xlsx"));
			StringBuilder sb = new StringBuilder();
	...
	public void sendTodayPurchaseReturnReport()
	{
		...
		try
		{
			PrintWriter pw = new PrintWriter(new File("E:\\databackup\\TodayPurchaseReturnReport.xlsx"));
			StringBuilder sb = new StringBuilder();			
