...
public class Mailer
{
	...
	{	
		...
		try
		{
			...
			*/
			...
			String filename2 = "E:\\databackup\\TodaySaleReport.xlsx";//change accordingly 
			...
			String filename3 = "E:\\databackup\\TodayPurchaseReport.xlsx";//change accordingly 
		   ...
		   String filename4 = "E:\\databackup\\TodaySaleReturnReport.xlsx";//change accordingly
		   ...
		   String filename5 = "E:\\databackup\\TodayPurchaseReturnReport.xlsx";//change accordingly
	...
	public static void sendAdvanceBooking(String to)
	{
		...
		{				
			...
			MimeBodyPart messageBodyPart2 = new MimeBodyPart();			  
			String filename1 = "E:\\databackup\\advanceBooking.csv";//change accordingly //DataSource
			DataSource source1 = new FileDataSource(filename1);
			messageBodyPart2.setDataHandler(new DataHandler(source1));
			messageBodyPart2.setFileName(filename1);
