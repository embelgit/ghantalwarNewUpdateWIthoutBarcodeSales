...
public class SupplierPaymentBean implements Serializable {
	...
	public SupplierPaymentBean(Long pkSupPaymentId, Long supplier, String billNo, String chequeNum, Long cardNum,
			...
			Double totalAmount, Double balance, Double credit, String paymentType, String description, String receiptNo,
			Double purchaseReturnedAmount, Long barCodeNo, Date insertDate, Long fkShopId) {
		super();
