...
public class ExpenditurePaymentBean {
	...
	public ExpenditurePaymentBean(Long pkExpPaymentId, Long fkExpenseTypeId, Long fkExpDetailId, String serviceProvider,
			Long contactNumber, String accountantName, String paymentType, Double crDbAmount, Double totalAmount,
			Date insertDate, Long fkShopId, ExpenditureDetailsBean expenditureDetailsBean) {
		super();
