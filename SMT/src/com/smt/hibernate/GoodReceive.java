...
public class GoodReceive
{
	...
	private String pReturnQuantity;
	...
	public GoodReceive(Long pkGoodRecId, String itemName, String catName, double quantity, Double buyPrice,
			Double salePrice, Double total, String billNo, String contactPerson, Double vat, Date date, Double expence,
			Double grossTotal, Long barcodeNo, Long supplierName, String ondate, double oringnalQuantity, Double igst,
			Double taxAmount, String hsnsacno, Double extraDiscount, String color, String size,
			Double pendingBillPayment, Long barcodeQty, double rollSize, String purcode, String supCode,
			Double discount, long subCatId, String suppName, double returnQuantity, String pReturnQuantity,
			double spWithoutTax, double disPerForBill, long firstBarcode, long lastBarcode, Double soldQuantity,
			String totalBuyPrice, String totalSalePrice, long fkCatId, long fkProductId, String style, long voucherNo,
			Date paymentDueDate, long bookingNo, Date purchaseEntryDate, Long fkShopId) {
		super();
		...
		this.pReturnQuantity = pReturnQuantity;
	...
	public String getpReturnQuantity() {
		return pReturnQuantity;
	}

	public void setpReturnQuantity(String pReturnQuantity) {
		this.pReturnQuantity = pReturnQuantity;
	}
