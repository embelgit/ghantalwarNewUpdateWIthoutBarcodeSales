...
public class CreditCustomerBill
{
	...
	public CreditCustomerBill(Long pkCreditBillId, Long fkRootCustId, String itemName, Double quantity,
			...
			Long pkItemId, Long barcodeNo, Double discount, Double totalperItem, String hsnSacNo, Double vat,
			Double igst, Double taxAmount, String paymentDone, Double pendingBillPayment, String billNo1,
			String empName, String cCBempType, Long cCBempIdFK, String size, String chequeNum, Long cardNum,
			Long accNum, Long regNumber, String paymentMode, String nameOnCheck, String bankName,
