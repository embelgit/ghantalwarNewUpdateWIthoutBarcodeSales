...
public class EmployeePaymentBean implements Serializable {
	...
	public EmployeePaymentBean(Date insertDate, Long pkEmployeePaymentId, Double credit, String personName,
			String reason, Long fk_employee_id, String chequeNum, String cardNum, Long accNum, String paymentMode,
			String nameOnCheck, String bankName, String paymentType, Long fkShopId) {
		super();
