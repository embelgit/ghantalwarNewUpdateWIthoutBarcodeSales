...
public class SaleReturn
{
	...
	public SaleReturn(Long pkBillId, Long catId, String itemName, Double quantity, Double salePrice, Double grossamt,
			java.util.Date current_date, Double totalAmt, Long billNo, String categoryName, Long barcodeNo,
			Long contactNo, Double discount, String carNo, java.util.Date date, Double editQuantity,
			Double afterQuantity, Double returnTotal, Double returnGrossTotal, String customerName, String type,
			Long fkCreditCustId, Long transactionId, Double gst, Double iGst, Double taxAmount, String returnReason,
