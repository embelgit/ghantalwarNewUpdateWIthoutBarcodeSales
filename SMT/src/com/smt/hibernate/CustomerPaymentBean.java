...
public class CustomerPaymentBean implements Serializable
{
	...
	public CustomerPaymentBean(Long pkCustPaymentId, Long customer, Long billNo, String chequeNum, Long cardNum,
			Long accNum, Long regNumber, String paymentMode, String nameOnCheck, String bankName, String personname,
			Double totalAmount, Double balance, Double credit, String paymentType, Date insertDate, String description,
			Double returnAmount, String receiptNo, Long fkShopId)
	{
		super();
