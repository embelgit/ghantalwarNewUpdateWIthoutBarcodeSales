...
public class TempCreditInvoice {
...
public void setSpAfterDis(String spAfterDis) {
	...
	public TempCreditInvoice(Long pkCreditBillId, Long fkRootCustId, String itemName, Double quantity, Double salePrice,
		Double grossamt, Date current_date, Double totalAmt, Long billNo, String categoryName, Long pkItemId,
		Long barcodeNo, Double discount, Double totalperItem, String hsnSacNo, Double vat, Double igst,
		Double taxAmount, String paymentDone, Double pendingBillPayment, String billNo1, String empName,
		String cCBempType, Long cCBempIdFK, String size, String chequeNum, Long cardNum, Long accNum, Long regNumber,
		String paymentMode, String nameOnCheck, String bankName, Double taxAmtAfterDiscount, Double perProductdisPer,
		Double spWithoutTaxAmount, String saleDate, Long fkSaleEmployeeId, Long fkProductId, Long fkSubCatId,
		Long fkCatId, Date billTime, String style, Double cashCard_cashAmount, Double cashCard_cardAmount,
		Double totalSaleReturnCreditAmt, Date cPaymentDueDate, Long fkSuppId, Long fkShopId, Long fkgoodReciveid,
		Double rollsize, String subcategory, String spAfterDis) {
	super();
...
public void setSubcategory(String subcategory) {
	...
	public Date getcPaymentDueDate() {
		return cPaymentDueDate;
	}

	public void setcPaymentDueDate(Date cPaymentDueDate) {
		this.cPaymentDueDate = cPaymentDueDate;
	}
