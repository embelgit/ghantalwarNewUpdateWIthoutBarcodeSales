...
public class PurchaseReturn
{
	...
	private Double purchaseRetunedBuyPrice;
	...
	public PurchaseReturn(Long pkPurchaseReturnId, String itemName, String catName, Long quantity, Double buyPrice,
			Double salePrice, Double total, Long billNo, String billNoStr, String contactPerson, Double vat, Date date,
			Double expence, Double grossTotal, Long barcodeNo, String supplierName, String ondate,
			Long oringnalQuantity, Double returnTotal, Double returnGrossTotal, Double discount, Double rollSize,
			Long fkSupplierId, Long transactionId, String size, Double iGst, Double taxAmount, Double disAmount,
			Long productId, Long subCatId, Long catId, String purchaseReturnReason, Double purchaseRetunedBuyPrice,
			Long fkShopId) {
		super();
		...
		this.purchaseRetunedBuyPrice = purchaseRetunedBuyPrice;
	...
	public Double getPurchaseRetunedBuyPrice() {
		return purchaseRetunedBuyPrice;
	}

	public void setPurchaseRetunedBuyPrice(Double purchaseRetunedBuyPrice) {
		this.purchaseRetunedBuyPrice = purchaseRetunedBuyPrice;
	}
	...
	public void setBillNoStr(String billNoStr) {
		this.billNoStr = billNoStr;
	}
