...
*/
			...
			Query query = session.createSQLQuery("SELECT pk_supplier_payment_id, description, insert_date, paymentType, payment from supplier_payment WHERE (insert_date BETWEEN '"+startDateCd+"' AND '"+endDateCd+"') AND (purchaseReturnedAmount = NULL OR purchaseReturnedAmount = 0)");
			list = query.list();
		...
		{
			System.out.println("creditCustList ====> "+creditCustList.size());
		...
		{
			System.out.println("creditCustPaymentList ====> "+creditCustPaymentList.size());
		...
		{
			System.out.println("saleReturnList ====> "+saleReturnList.size());
		...
		{
			System.out.println("expenditureList ====> "+expenditureList.size());
		...
		{
			System.out.println("employeeCreditDebitList ====> "+employeeCreditDebitList.size());
		...
		{
			System.out.println("purchaseReturnList ====> "+purchaseReturnList.size());
