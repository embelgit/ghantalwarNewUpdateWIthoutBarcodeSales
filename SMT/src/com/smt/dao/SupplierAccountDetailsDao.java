...
public class SupplierAccountDetailsDao {
	...
	public List getTotalAmtByBillNoForCustomer(String billNo, String supplierId, String shopId)
	{
		HibernateUtility hbu = null;
		Session session = null;
		List list = null;
	...
	public List getbalanceAmtByBillNo(String billNo, String supplier, String shopId)
	{
		HibernateUtility hbu = null;
		Session session = null;
		List list = null;
	...
	public Double getTotalAmt(String billNo, String supplier, String shopId)
	{
		HibernateUtility hbu = null;
		Session session = null;
