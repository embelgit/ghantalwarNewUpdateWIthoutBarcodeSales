...
public class PurchaseReturnDao {
	...
	public void updateQuantity(Long PkGoodRecId, String editQuantity, String total, String totalAmount, String billNo, String supplierIdLong, String returnTotal, String shopId)
	{
		// TODO Auto-generated method stub
		...
		try
		{
			...
			grd.setPendingBillPaymentToSupp(newPendingBillpayment, supplierIdLong, shopId);	
	...
	public void getTotalAndPendingBillPayment(String supplierId, Date adate, String totalReturnTotal, String barcodeNo, Long shopId)
	{
		HibernateUtility hbu = null;
		Session session = null;
		hbu = HibernateUtility.getInstance();
		...
		Query query = session.createSQLQuery("select SUM(gr.Total), gr.pending_bill_payment from goodreceive gr where FksuppId = "+supplierId+" AND gr.fkShopId = "+shopId);
