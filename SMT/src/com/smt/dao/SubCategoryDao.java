...
public class SubCategoryDao
{
	...
	public void deleteSubCategory(Long pk_SubCat_id)
	{
		// TODO Auto-generated method stub
		...
		try {
			...
			session = hbu.getHibernateSession();
			transaction = session.beginTransaction();
			Query deleteSubQuery = session.createQuery("update SubCategory Set activeYn = :n where pkSubcatId = :pk_SubCat_id");
			deleteSubQuery.setParameter("n", n);
			deleteSubQuery.setParameter("pk_SubCat_id", pk_SubCat_id);
