...
public class SupplierEditBean {
	...
	public String getgRSize() {
		return gRSize;
	}

	public void setgRSize(String gRSize) {
		this.gRSize = gRSize;
	}
	...
	public String getPendingSuppBalance() {
		return pendingSuppBalance;
	}

	public void setPendingSuppBalance(String pendingSuppBalance) {
		this.pendingSuppBalance = pendingSuppBalance;
	}
