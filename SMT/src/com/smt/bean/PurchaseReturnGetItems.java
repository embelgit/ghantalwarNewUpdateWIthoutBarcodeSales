...
public class PurchaseReturnGetItems
{
	...
	public String getDuplicateEditableBuyPrice() {
		return duplicateEditableBuyPrice;
	}

	public void setDuplicateEditableBuyPrice(String duplicateEditableBuyPrice) {
		this.duplicateEditableBuyPrice = duplicateEditableBuyPrice;
	}
