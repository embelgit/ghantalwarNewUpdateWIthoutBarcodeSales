...
{	
	...
	if(count < 1)
	{
		myAlert("Please Select Product To Return");
		return false;
	}
	...
	for (var i = 0; i < count; i++)
	{
		...
		{
			myAlert("Please Enter Return Quantity For :: "+(i+1)+" "+itemName);
			return false;
		}
	...
	*/
		...
		var duplicateEditableBuyPrice = allRowsInGrid[i].duplicateEditableBuyPrice;
		params["duplicateEditableBuyPrice" + i] = duplicateEditableBuyPrice;
		...
		var billNo = allRowsInGrid[i].billNoStr;
		...
		document.getElementById('supplierId').value = "";
				...
				{					
					for (var j = 0; j < count; j++) 
					{
						...
						{	
							myAlert("Please Select Same Supplier !!!");
							newrow=false;
							break;
							//return false;
						}
					...
					$("#jqGrid").jqGrid(
							{
								...
								colNames : ["itemID", "Supplier<br>Name", "Bill<br>No.", "Date", "catId", "Category", "productId",
											...
											"Total", "originalTotal", "Contact<br>Person", "Supplier Id", "Gross Total", "fkShopId"],
								             ...
								             {
								            	 name : 'duplicateEditableBuyPrice',
								            	 width : 100,
								            	 editable: true,
								            	 editoptions:{
														dataInit: function(element)
								             ...
								             afterSaveCell: function ()
								             {
								            	 ...
								            	 var duplicateEditableBuyPrice = rowData['duplicateEditableBuyPrice'];
								            	 var vat = rowData['vat'];
								            	 ...
								            	 {
								            		 if(duplicateEditableBuyPrice.match(checkValue))
								            		 {}
								            		 else
								            		 {
									            		 myAlert("Please Enter Returned Buy Price");
									            		 $("#jqGrid").jqGrid("setCell", rowId, "duplicateEditableBuyPrice", buyPrice);
								            		 }
								            	 }
								            	 else
								            	 { 
								            	 ...
								            	 /*if(duplicateEditableBuyPrice > 0)
								            	 {
								            		 buyPrice = duplicateEditableBuyPrice;
								            	 }*/
								            	 ...
								            	 if (unit == "meter"
														...
														|| unit == "Mtr")
												{
								            		total1 = (editQuantity*rollS) * duplicateEditableBuyPrice;
												}
								            	else
								            	{
								            		total1 = editQuantity * duplicateEditableBuyPrice;
								            	}
								            	if (dis != "0") 
												{
									            	 dist = (total1*dis)/100;
