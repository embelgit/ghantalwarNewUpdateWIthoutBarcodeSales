...
<ul class="nav nav-tabs"  >
							<li class="active"     padding-left: 50;><a data-toggle="tab"
								href="#below10"><h4 style="color: blue">Below 10 Qty</h4></a></li>
							<li><a data-toggle="tab"
								href="#below20"><h4
										style="color: blue">Below 20 Qty</h4></a></li>
							<li><a data-toggle="tab" href="#below40"><h4
										style="color: blue">Below 40 Qty</h4></a></li>
		</ul>
