<%@page import="com.smt.utility.CheckInternetConn"%>
...
try {
	...
	headerTable_cell21 = new PdfPCell(new Phrase("GHANTALWAR MENS WEAR", font10Bold));
	...
	headerTable_cell21 = new PdfPCell(new Phrase("Main Road,\nTamsa", font10));
	headerTable_cell21.setHorizontalAlignment(Element.ALIGN_LEFT);
	headerTable_cell21.setPaddingBottom(2);
	headerTable_cell21.setBorder(Rectangle.NO_BORDER);
	headertable21.addCell(headerTable_cell21);
...
double price = rs.getDouble("purchaseRetunedBuyPrice");
...
try{
	...
	if(checkI > 0)
	{
	    ...
	    transport.close();
	    out.println("PURCHASE RETURN PDF SENT");
	}
	else
	{
