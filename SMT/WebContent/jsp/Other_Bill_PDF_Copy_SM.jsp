...
<%
	...
	try
	{
		...
		conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/cloth", "root", "root");
...
try
{	
	//String emailId = "cr7rohanchhajed7@gmail.com";
	String emailId = "sagarembel@gmail.com";
	String vendorName = ""; 
