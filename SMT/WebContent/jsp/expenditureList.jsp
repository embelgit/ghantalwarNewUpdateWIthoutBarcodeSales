	...
	<div class="container-fluid">
		<div class="row">
			<div class="form-group" align="left">
				<div class="col-md-4 control-label" id="billheading"
					style="padding-top: 3%; width: auto;">
					<div id="date">
						<label id="demo"></label>
						<script>
							var date = new Date();
		...
		<div class="row" align="center">
			<div class="table-responsive" style="width: 430">
				...
				<div class="wrapper" align="center" style="margin-top: 15px;">
