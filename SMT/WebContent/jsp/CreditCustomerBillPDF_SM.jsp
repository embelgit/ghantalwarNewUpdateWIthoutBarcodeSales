	...
	try {
		...
		while (rs.next()) {
			if (a < 6) {
				...
				table_cell = new PdfPCell(new Phrase(" " + itemName+"-"+barcode));
		...
		if (a > 1 && a <= 6) {
			...
			table_cell = new PdfPCell(new Phrase("" + df.format(totalDiscount), font13));
			table_cell.setHorizontalAlignment(Element.ALIGN_CENTER);
		...
		try{
		    ...
		    m.setSubject("CREDIT CUSTOMER INVOICE");
		    ...
		    messageBodyPart.setFileName("Credit Customer Bill.pdf");
		    multipart.addBodyPart(messageBodyPart);
			...
			System.out.println("CREDIT CUSTOMER BILLING PDF SENT");
		}catch(Exception e){
