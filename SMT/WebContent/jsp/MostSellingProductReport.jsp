...
<body class="stock_form_img vColor">
	<div class="container col-md-offset-5" id="reportheight">
		...
		<div class="miscellaneous" style="margin-left: 12%;">	
		<div class="container">
		<div class="row">
			...
			<div class="invoice_label_up">
               <div class="col-md-6 col-sm-12 col-xs-12 col-xl-4 col-lg-4" id="profitreport">	
				...
				<input list="catId_drop" id="catId" 
							onchange="getCategoryWiseItemName()"  required style="font-size: 16px;">
				...
				<input type="button" value="Search" id="btn"
					...
					class="btn btn-lg btn-success btn-md button_hw button_margin_right" style="padding-bottom: 31px;"/>
			</div>
		</div>
		</div>
		</div>
