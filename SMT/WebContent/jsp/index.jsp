            ...
            <div class="col-xl-3 col-md-6 mb-4">
              <div class="card border-left-success shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Purchase (Daily)</div>
                      <input type="text" id="purchaseid" readonly="readonly"  style="background: #f0f0f0; border: 2px;font-size:25px;width: 150px;">
                    </div>
                    <div class="col-auto">
             ...
             <div class="col-xl-3 col-md-6 mb-4">
              <div class="card border-left-success shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Purchase (Yesterday)</div>
                      <input type="text" id="purchaseid1" readonly="readonly"  style="background: #f0f0f0; border: 2px;font-size:25px;width: 150px;">
                    </div>
                    <div class="col-auto">
                      <i class="fas fa-dollar-sign fa-2x text-gray-300"></i>
                    </div>
          ...
          <div class="col-xl-3 col-md-6 mb-4">
              <div class="card border-left-info shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Most Sell(10 Pics Daily)</div>
                      <div class="row no-gutters align-items-center">
                        <div class="col-auto">
                          <select id="Mostsell"  style="background: #f0f0f0; border: 2px;font-size:25px;width: 170px;"></select>
                        </div>
