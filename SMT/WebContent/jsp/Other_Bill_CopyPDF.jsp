...
try {
	...
	ResultSet rs = stmt.executeQuery("select ItemName, CategoryName, Quantity, SalePrice, ContactNo, OwnerName, TotalAmount, Discount, GrossTotal, Date, totalperitem, TaxAmount,credit_Customer_Name,mobile_No,Gst,Igst,HsnSacNo,payment_mode,BarcodeNo,employee_Name from otherbill where BillNo ="+billno);
