 ...
 -->
						<div class="col-lg-7 col-md-12 col-xs-12 col-sm-12"
							...
							<div class="alert alert-danger" role="alert">
								...
								<h5 style="color: red; text-align: center;">NOTE: IN FUTURE
					...
					<div class="row" style="margin-top: 3%;">
						<div class="col-lg-2" style="display: inline-block;">
							...
							<input type="button" name="btn" value="Submit"
								...
								style="padding-top: 8px; width: 124px;" onclick="checkUser();" />
						...
						<div class="col-lg-2" style="display: inline-block;">
							...
							<input type="button" name="btn" value="List" id="listBtnUser"
								style="padding-top: 8px; width: 124px;"
						...
						<div class="col-lg-2" style="display: inline-block;">
							...
							<input type="button" name="btn" onclick="gpToEditUserDetails();"
								style="padding-top: 8px; width: 124px;" value="Edit"
