...
<div class="form-group" align="left">
			...
			<div class="col-md-2 col-md-offset-3 align" align="center"
				...
				<h2 class="form-name style_heading">Shop Details</h2>
			</div>
		</div>
				...
				<div class="container" id="categoryListOfProductDetails">
					<div class="row">
						<div class="col-md-6 col-sm-12 col-xs-12 col-xl-4 col-lg-4"
							id="dayreport">
							<input type="text" input-sm" id='shopNameSd' name='shopNameSd'>
						...
						<div class="col-md-6 col-sm-12 col-xs-12 col-xl-4 col-lg-4"
							...
							<input type="text" input-sm" id='contactNumber' name='contactNumber' maxlength="10">
					...
					<div class="row">
						<div class="col-md-6 col-sm-12 col-xs-12 col-xl-4 col-lg-4"
							id="dayreport">
							<input type="text" input-sm" id='gstNo' name='gstNo'>
						...
						<div class="col-md-6 col-sm-12 col-xs-12 col-xl-4 col-lg-4"
							...
							<label>Shop Address<sup style="color: red;">*</sup></label>
						</div>
					</div>
					...
					<div class="row">
						<div class="col-md-6 col-sm-12 col-xs-12 col-xl-4 col-lg-4"
							id="dayreport">
							<input type="text" input-sm" id='cityName' name='cityName'>
					...
					<div class="row col-md-offset-2">
						...
						<div align="center">
							<div class="col-lg-2" style="display: inline-block;">
								<input type="button" onclick="addShop()" name="btn"
